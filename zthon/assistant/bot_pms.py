...
async def bot_start(event):
    ...
    if chat.id != Config.OWNER_ID:
        ...
        start_msg = "ٴ⌯╼═══❬ ᥉᥆υᖇᥴᥱ ᥉ᥱꪔ᥆ ❭═══╾⌯\n\n🎤╖ أهلآ بك عزيزي أنا بوت » سيمو\n\n⚙️╢ وظيفتي حماية المجموعات\n\n✅╢ لتفعيل البوت عليك اتباع مايلي\n\n✨╢ أضف البوت إلى مجموعتك\n\n🔘╢ أرفعه : مشرف\n\n📖╜ لرؤيـة الاوامـر ارسل :  /samir\n\n ٴ⌯╼═══❬ ᥉᥆υᖇᥴᥱ ᥉ᥱꪔ᥆ ❭═══╾⌯"
        buttons = [
            [
                Button.url("• السورس •", "t.me/FTTUTY"),
...
@zedub.bot_cmd(pattern="^ايدي$", from_users=Config.OWNER_ID)
async def bot_start(event):
    reply_to = await reply_id(event)
    if not reply_to:
...
async def send_flood_alert(user_) -> None:  # sourcery skip: low-code-quality
    ...
    if found:
        ...
        try:
            ...
            if BOTLOG:
                await zedub.tgbot.send_message(BOTLOG_CHATID, "**الغاء ححظر بوتك !**")
