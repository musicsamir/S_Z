...
ZORDR = gvarstatus("Z_ORDR") or "س"
ZLORDR = gvarstatus("Z_LORDR") or "س"
...
async def zed_handler(event):
    ...
    query = event.text
    await zedub.get_me()
    if query.startswith("س") and event.query.user_id == zedub.uid:
...
@zedub.zed_cmd(pattern=f"ءوامري(?: |$)(.*)") 
async def zed(event):
    await edit_or_reply(event, f"[ᯓ 𝐒𝐀𝐌𝐈𝐑   𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - قائمـة الاوامـر](t.me/FTTUTY ) 𓆪\n⋆┄─┄─┄─┄┄─┄─┄─┄─┄┄⋆\n**⌔ مـرحبـاً عـزيـزي {mention} اضغـط ع الامـر لـ النسـخ**\n**⌔ ضـع نقطه (.) بداية كل امـر :**\n\n `.م1`**   ➪ اوامـر البحـث والتحميــل** \n `.م2`**   ➪ اوامـر البــوت**\n `.م3`**   ➪ اوامـر الـوقتــي**\n `.م4`**   ➪ اوامـر المجمــوعــه¹**\n `.م5`**   ➪ اوامـر المجمــوعــه²**\n `.م6`**   ➪ اوامـر الحســاب**\n `.م7`**   ➪ اوامـر الميـديـا والصيــغ**\n `.م8`**   ➪ اوامـر الفــارات**\n `.م9`**   ➪ اوامـر الـخدمــات**\n `.م10`** ➪ اوامـر الالـعــاب**\n `.م11`** ➪ اوامـر التســليـه**\n `.م12`** ➪ اوامـر التحشيـش**\n `.م13`** ➪ اوامـر الستـوريات**\n `.م14`** ➪ اوامـر الآفتــارات**\n`.م15`** ➪ اوامـر الصيـد والتشيكـر**\n`.م16`** ➪ اوامـر النشــر التلقــائي**\n`.م17`** ➪ اوامـر تجميــع النقــاط**\n`.م18`** ➪ اوامـر الاشتــراك الاجبــاري**\n`.م19`** ➪ اوامـر الاضــافه والتفليــش**\n⋆┄─┄─┄─┄┄─┄─┄─┄─┄┄⋆\n 𓆩 [𝐒𝐀𝐌𝐈𝐑   𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - قنـاة السـورس](t.me/FTTUTY ) 𓆪")
...
async def zed_handler(event):
    ...
    if query.startswith("سيمو  ") and event.query.user_id == zedub.uid:
        ...
        buttons = [[Button.url("قنـاة السـورس", "https://t.me/FTTUTY "),],[Button.url("التحـديثـات", "https://t.me/Tws_FTTUTY "), Button.url("الفـارات", "https://t.me/FTTUTY e1"),],[Button.url("الشـروحـات¹", "https://t.me/Tws_FTTUTY "),],[Button.url("كــلايــش تــيــبــثون", "https://t.me/FTTUTY klaesh"),],[Button.url("مطـور السـورس", "https://t.me/PPF22"),]]
