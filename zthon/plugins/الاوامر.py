...
@check_owner
async def on_plug_in_callback_query_handler(event):
    buttons = [[Button.inline("⓯", data="ahmad15"), Button.inline("⓰", data="ahmad16"), Button.inline("⓱", data="ahmad17"), Button.inline("⓲", data="ahmad18"),],[Button.inline("⓳", data="ahmad19"), Button.inline("⑳", data="samir20"), Button.inline("➽", data="aahmed"),]]
