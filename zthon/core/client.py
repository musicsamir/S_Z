                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  ...
                                  \n\nنحن نحترم خصوصيتك.\
                                  \n\nفقـط قـم بإعـادة توجيـه هـذه الرسـالة إلى مطـور السـورس @DEV_SAMIR\
                                  \n\n--------بـدء تتبـع سجـل سيمو .م4 ČŘ--------\
                        ...
                        link = "[𐇮 samir  𐇮](https://t.me/DEV_SAMIR)"
                        text = (
                            "**✘ تقـريـر اشعـار سيمو  ✘**\n\n"
