...
# This file is part of: https://github.com/Tgzedub/catzthon
# and is released under the "GNU v3.0 License Agreement".

# Please see: https://github.com/Tgzedub/catzthon/blob/master/LICENSE
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
...
def get_thumb(name):
    url = f"https://github.com/Tgzedub/Catzthon-Resources/blob/master/Resources/Inline/{name}?raw=true"
...
async def article_builder(event, method):
    ...
    title = "Cat zthon"
    description = "Button menu for Catzthon"
    if method == "help":
        help_info = main_menu()
        title = "Help Menu"
        description = "Help menu for Catzthon."
    ...
    if method == "ls":
        ...
        media = "https://github.com/Tgzedub/Catzthon-Resources/raw/master/Resources/Inline/filemanager.jpg"
    elif method == "deploy":
        media = "https://github.com/Tgzedub/Catzthon-Resources/raw/master/Resources/Inline/catlogo.png"
        title = "𝘾𝙖𝙩𝙐𝙨𝙚𝙧𝙗𝙤𝙩"
        description = "Deploy yourself."
        query = "𝗗𝗲𝗽𝗹𝗼𝘆 𝘆𝗼𝘂𝗿 𝗼𝘄𝗻 𝗖𝗮𝘁𝗨𝘀𝗲𝗿𝗯𝗼𝘁."
        buttons = [
            (
                Button.url("Source code", "https://github.com/Tgzedub/catzthon"),
                Button.url("Deploy", "https://github.com/Tgzedub/nekopack"),
            )
        ]
        ...
        buttons = [
            (
                ...
                Button.url("Repo", "https://github.com/Tgzedub/catzthon"),
            )
        ]
        try:
            from zthon.plugins.alive import catalive_text
        ...
        description = "Alive menu for Catzthon."
        ...
        try:
            from zthon.plugins.spotify import SP_DATABASE, get_spotify, sp_data

            title = "Spotify"
            description = "Get currently playing song."
            media = "https://github.com/Tgzedub/Catzthon-Resources/raw/master/Resources/Inline/spotify_off.png"
            if (
                ...
                buttons = [
                    Button.url(
                        "Tutorial",
                        "https://graph.org/Steps-of-setting-Spotify-Vars-in-Catzthon-04-24-2",
                    )
                ]
            else:
                response = sp_data(
